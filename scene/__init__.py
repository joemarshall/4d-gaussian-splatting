...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, load_iteration=None, shuffle=True, resolution_scales=[1.0], num_pts=100_000, num_pts_ratio=1.0, time_duration=None):
        ...
        if os.path.exists(os.path.join(args.source_path, "sparse")):
            scene_info = sceneLoadTypeCallbacks["Colmap"](args.source_path, args.images, args.eval, num_pts_ratio=num_pts_ratio, dataloader=args.dataloader)
    ...
    def init_gaussians_from_scene(self):
        ...
        if sys.platform == "win32":
            ...
            all_colors = SH2RGB(self.gaussians.get_sh_features_dc.detach().clone().squeeze(1))
