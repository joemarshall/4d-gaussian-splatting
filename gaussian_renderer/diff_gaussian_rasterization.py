...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            try:
                num_rendered, color, flow, depth, T, radii, geomBuffer, binningBuffer, imgBuffer, covs_com, out_means3D,out_metric_counts = _C.rasterize_gaussians(*args)
        ...
        return color, radii, depth, 1-T, flow, covs_com, out_metric_counts

    @staticmethod
    def backward(ctx, grad_out_color, grad_radii, grad_depth, grad_alpha, grad_flow, grad_covs_com,grad_metric_counts):
        ...
        grad_names = ["grad_means3D", "grad_means2D", "grad_sh", "grad_colors_precomp", "grad_flows", "grad_opacities",
                      "grad_ts", "grad_scales", "grad_scales_t", "grad_rotations", "grad_rotations_r", "grad_cov3Ds_precomp","None","None"]
